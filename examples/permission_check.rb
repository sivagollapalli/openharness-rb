...
harness.query("Search query_engine.rb file in current directories and then copy contents to called query_engine_dup.rb file in the same directory?") do |event|
  case event
